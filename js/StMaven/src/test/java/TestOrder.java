...
//        获取dao接口的实现类对象
       orderDao = this.session.getMapper(OrderDao.class);
    }
...
//        资源关闭
    ...
    public void testAddOrder(){
        ...
        order.setUserId(39);
        order.setLoginName("IKUN");
        order.setUserAddress("asdasda");
        order.setSerialNumber("5645");
    ...
    public void testGetOrderById(){
        List<Order> orderByUserId = orderDao.getOrderByUserId(39);
